...
<head>
	...
	<form  style="width: 600px;" action="voter2.php"  method="POST" >
  <fieldset >
  	
    <legend>Enter Election ID provided by the  Organizer:</legend>
    election id1:<input type="text" name="elecid" required="Enter">
